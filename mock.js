...
const data = [{
        ...
        "data": {
            "data|30": [{
                "day_total": "@integer(0,100000)",
                "total": "@integer(0,100000)",
                "playerid": "@integer(100000,300000)",
                "nick_name": "@string('lower',4)"
            }]
        }
    },
    {
    ...
    },
    {
        ...
        "data": {
            "data": {
                "draw_list|20": [{
                    "createtime": "759883437303",
                    "lottery": "@integer(0,100000)"
                }]
            }
        }
    },
